...
public class GenerateHtmlJob {
    ...
    public static void main(String[] args) {
        String filename = String.format("%s/setmeal_%d.html","D:/codes/health/ago_health_parent/health_mobile/src/main/webapp/pages", 12);
