...
public class QiNiuUtils {
    ...
    private static final String ACCESSKEY = "azDL16lMp73Tdiy-i6Lv4UD5IZUrBbOVw8DLJlaI";
    private static final String SECRETKEY = "Vf0AIL7VbfvHky32ckSYJLjWXwVg29EYP0IRKwaE";
    private static final String BUCKET = "sz1000";
    public static final String DOMAIN= "http://qh3ujj6gk.hn-bkt.clouddn.com/";

    public static void main(String[] args) {
        uploadFile("C:\\Users\\Terrance\\Desktop\\file\\aaa.png","bbb.jpg");
